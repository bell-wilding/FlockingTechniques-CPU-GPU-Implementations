...
Quaternion NCL::Maths::Quaternion::LookRotation(const Vector3& f, const Vector3& u) {
	// Taken from: http://answers.unity3d.com/questions/467614/what-is-the-source-code-of-quaternionlookrotation.html

	Vector3 forward = f.Normalised();
	Vector3 right = Vector3::Cross(u, forward).Normalised();
